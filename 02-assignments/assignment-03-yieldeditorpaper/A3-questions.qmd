...
After answering all questions, render this quarto file to html, include your last name on the file name (e.g., A3-questions-Bastos.html) and send to **lmbastos@uga.edu** by **Tuesday, Feb 08 11:59 pm**.  
